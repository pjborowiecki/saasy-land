import { createTestRequestUrl, TEST_APP_URL } from "~/src/platform/testing/test-request"

import { authEmailHandlers } from "~/src/modules/identity-access/infrastructure/auth/auth.emails"
...
vi.mock(import("~/src/modules/identity-access/infrastructure/email/send-email"), () => ({

...
import "~/src/modules/identity-access/infrastructure/auth/auth._server"
...
vi.mock(import("~/src/integrations/redis/redis.config"), (): typeof RedisConfigModule => ({
  createAppRedis: (client) => ({
  ...
  createAppRedisFromConstructor: (RedisCtor, config) => {

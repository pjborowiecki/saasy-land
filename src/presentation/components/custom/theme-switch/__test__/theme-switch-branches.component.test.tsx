...
import { setThemeMock, themeState } from "~/src/presentation/providers/__test__/mocks/wrksz-themes"
...
describe("themeSwitchClient branches", () => {
  ...
  it("ignores non-string and invalid theme values from onChange", async () => {
    expect.hasAssertions()
    setThemeMock.mockClear()
    themeState.value = "light"
    ...
    themeChangeHandler.current?.(nonStringKey)
